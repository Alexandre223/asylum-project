...
* 		  exclude Denmark and Netherlands because of many early       *
*		  elections                                                   *
* YEARS: 2002 - 2014                                                  *
...
drop if destination == "Cyprus" | destination == "Netherlands" |  ///
		destination == "Denmark"

tab destination
	
* Match with top 90% origin countries
merge m:1 origin using ./out/data/temp/source_countries_app_few_early_elections.dta
keep if _merge == 3
drop _merge
...
save ./out/data/final_application/few_early_elections.dta, replace
