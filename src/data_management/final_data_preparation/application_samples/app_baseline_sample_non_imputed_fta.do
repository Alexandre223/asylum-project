...
* BASELINE SAMPLE USING ONLY NON IMPUTED FIRST-TIME APPLICATION DATA  *
* =================================================================== *
...
bysort destination: egen total_FTapp = total(firsttimeapp_NI)
...
do ./src/data_management/final_data_preparation/modules/calc_mean_dyadic_ft_applications_not_imputed.do
...
save ./out/data/final_application/baseline_non_imputed_fta.dta, replace
