...
*		BASELINE SAMPLE WITH NORMALIZED CABINET POSITION              *
* =================================================================== *
* SAMPLE: all big countries that have a maximum of two missing years  *
*		  in total decision data                                      *
* YEARS: 2002 - 2014                                                  *
* CABINET POSITION: left, right, normalized on country level,         *
* 					split at median                      			  *
...
merge m:1 origin using ./out/data/temp/source_countries_dec_baseline.dta
keep if _merge == 3
drop _merge  
...
save ./out/data/final_decision/baseline_normalized_cabinet.dta, replace
