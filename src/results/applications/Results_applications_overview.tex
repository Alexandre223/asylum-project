...
\input{../../../out/analysis/applications/tables/app_summary_statistics.tex}
 
\input{../../paper/inputs/app_elections_overview.tex} 
...
\begin{table}[!ht]\centering
	...
	\begin{tabular}{l*{3}{c}}
		\hline\hline
		\input{../../../out/analysis/applications/tables/app_table1_R22.tex}
		\hline\hline
		\multicolumn{4}{l}{\footnotesize Standard errors in parentheses (\sym{*} \(p<0.05\), \sym{**} \(p<0.01\), \sym{***} \(p<0.001\))}\\
	\end{tabular}
\end{table}
...
\begin{table}[!ht]\centering
	...
	\begin{tabular}{l*{2}{c}}
		\hline\hline
		\input{../../../out/analysis/applications/tables/app_graph1_R22_coef.tex}
		\hline\hline
		\multicolumn{3}{c}{\footnotesize Standard errors in parentheses} \\
		\multicolumn{3}{c}{\footnotesize (\sym{*} \(p<0.05\), \sym{**} \(p<0.01\), \sym{***} \(p<0.001\))}\\
	\end{tabular}
...
\begin{table}[!ht]\centering
	...
	\begin{tabular}{l*{2}{c}}
		\hline\hline
		\input{../../../out/analysis/applications/tables/app_graph2_R22_coef.tex}
		\hline\hline
		\multicolumn{3}{c}{\footnotesize Standard errors in parentheses} \\
		\multicolumn{3}{c}{\footnotesize (\sym{*} \(p<0.05\), \sym{**} \(p<0.01\), \sym{***} \(p<0.001\))} \\
	\end{tabular}
...
\begin{table}[!ht]\centering
	...
	\begin{tabular}{l*{3}{c}}
		\hline\hline
		\input{../../../out/analysis/applications/tables/app_table1_R23.tex}
		\hline\hline
		\multicolumn{4}{l}{\footnotesize Standard errors in parentheses (\sym{*} \(p<0.05\), \sym{**} \(p<0.01\), \sym{***} \(p<0.001\))}\\
	\end{tabular}
\end{table}
...
\begin{table}[!ht]\centering
	...
	\begin{tabular}{l*{2}{c}}
		\hline\hline
		\input{../../../out/analysis/applications/tables/app_graph1_R23_coef.tex}
		\hline\hline
		\multicolumn{3}{c}{\footnotesize Standard errors in parentheses} \\
		\multicolumn{3}{c}{\footnotesize (\sym{*} \(p<0.05\), \sym{**} \(p<0.01\), \sym{***} \(p<0.001\))}\\
	\end{tabular}
...
\begin{table}[!ht]\centering
	...
	\begin{tabular}{l*{2}{c}}
		\hline\hline
		\input{../../../out/analysis/applications/tables/app_graph2_R23_coef.tex}
		\hline\hline
		\multicolumn{3}{c}{\footnotesize Standard errors in parentheses} \\
		\multicolumn{3}{c}{\footnotesize (\sym{*} \(p<0.05\), \sym{**} \(p<0.01\), \sym{***} \(p<0.001\))} \\
	\end{tabular}
...
\begin{table}[!ht]\centering
	...
	\begin{tabular}{l*{3}{c}}
		\hline\hline
		\input{../../../out/analysis/applications/tables/app_table1_R01.tex}
		\hline\hline
		\multicolumn{4}{l}{\footnotesize Standard errors in parentheses (\sym{*} \(p<0.05\), \sym{**} \(p<0.01\), \sym{***} \(p<0.001\))}\\
	\end{tabular}
\end{table}
...
\begin{table}[!ht]\centering
	...
	\begin{tabular}{l*{2}{c}}
		\hline\hline
		\input{../../../out/analysis/applications/tables/app_graph1_R01_coef.tex}
		\hline\hline
		\multicolumn{3}{c}{\footnotesize Standard errors in parentheses} \\
		\multicolumn{3}{c}{\footnotesize (\sym{*} \(p<0.05\), \sym{**} \(p<0.01\), \sym{***} \(p<0.001\))}\\
	\end{tabular}
...
\begin{table}[!ht]\centering
	...
	\begin{tabular}{l*{2}{c}}
		\hline\hline
		\input{../../../out/analysis/applications/tables/app_graph2_R01_coef.tex}
		\hline\hline
		\multicolumn{3}{c}{\footnotesize Standard errors in parentheses} \\
		\multicolumn{3}{c}{\footnotesize (\sym{*} \(p<0.05\), \sym{**} \(p<0.01\), \sym{***} \(p<0.001\))} \\
	\end{tabular}
...
\begin{table}[!ht]\centering
	...
	\begin{tabular}{l*{3}{c}}
		\hline\hline
		\input{../../../out/analysis/applications/tables/app_table1_R02.tex}
		\hline\hline
		\multicolumn{4}{l}{\footnotesize Standard errors in parentheses (\sym{*} \(p<0.05\), \sym{**} \(p<0.01\), \sym{***} \(p<0.001\))}\\
	\end{tabular}
\end{table}
...
\begin{table}[!ht]\centering
	...
	\begin{tabular}{l*{2}{c}}
		\hline\hline
		\input{../../../out/analysis/applications/tables/app_graph1_R02_coef.tex}
		\hline\hline
		\multicolumn{3}{c}{\footnotesize Standard errors in parentheses} \\
		\multicolumn{3}{c}{\footnotesize (\sym{*} \(p<0.05\), \sym{**} \(p<0.01\), \sym{***} \(p<0.001\))}\\
	\end{tabular}
...
\begin{table}[!ht]\centering
	...
	\begin{tabular}{l*{2}{c}}
		\hline\hline
		\input{../../../out/analysis/applications/tables/app_graph2_R02_coef.tex}
		\hline\hline
		\multicolumn{3}{c}{\footnotesize Standard errors in parentheses} \\
		\multicolumn{3}{c}{\footnotesize (\sym{*} \(p<0.05\), \sym{**} \(p<0.01\), \sym{***} \(p<0.001\))} \\
	\end{tabular}
...
\begin{table}[!ht]\centering
	...
	\begin{tabular}{l*{3}{c}}
		\hline\hline
		\input{../../../out/analysis/applications/tables/app_table1_R03.tex}
		\hline\hline
		\multicolumn{4}{l}{\footnotesize Standard errors in parentheses (\sym{*} \(p<0.05\), \sym{**} \(p<0.01\), \sym{***} \(p<0.001\))}\\
	\end{tabular}
\end{table}
...
\begin{table}[!ht]\centering
	...
	\begin{tabular}{l*{2}{c}}
		\hline\hline
		\input{../../../out/analysis/applications/tables/app_graph1_R03_coef.tex}
		\hline\hline
		\multicolumn{3}{c}{\footnotesize Standard errors in parentheses} \\
		\multicolumn{3}{c}{\footnotesize (\sym{*} \(p<0.05\), \sym{**} \(p<0.01\), \sym{***} \(p<0.001\))}\\
	\end{tabular}
...
\begin{table}[!ht]\centering
	...
	\begin{tabular}{l*{2}{c}}
		\hline\hline
		\input{../../../out/analysis/applications/tables/app_graph2_R03_coef.tex}
		\hline\hline
		\multicolumn{3}{c}{\footnotesize Standard errors in parentheses} \\
		\multicolumn{3}{c}{\footnotesize (\sym{*} \(p<0.05\), \sym{**} \(p<0.01\), \sym{***} \(p<0.001\))} \\
	\end{tabular}
...
\begin{table}[!ht]\centering
	...
	\begin{tabular}{l*{3}{c}}
		\hline\hline
		\input{../../../out/analysis/applications/tables/app_table1_R04.tex}
		\hline\hline
		\multicolumn{4}{l}{\footnotesize Standard errors in parentheses (\sym{*} \(p<0.05\), \sym{**} \(p<0.01\), \sym{***} \(p<0.001\))}\\
	\end{tabular}
\end{table}
...
\begin{table}[!ht]\centering
	...
	\begin{tabular}{l*{2}{c}}
		\hline\hline
		\input{../../../out/analysis/applications/tables/app_graph1_R04_coef.tex}
		\hline\hline
		\multicolumn{3}{c}{\footnotesize Standard errors in parentheses} \\
		\multicolumn{3}{c}{\footnotesize (\sym{*} \(p<0.05\), \sym{**} \(p<0.01\), \sym{***} \(p<0.001\))}\\
	\end{tabular}
...
\begin{table}[!ht]\centering
	...
	\begin{tabular}{l*{2}{c}}
		\hline\hline
		\input{../../../out/analysis/applications/tables/app_graph2_R04_coef.tex}
		\hline\hline
		\multicolumn{3}{c}{\footnotesize Standard errors in parentheses} \\
		\multicolumn{3}{c}{\footnotesize (\sym{*} \(p<0.05\), \sym{**} \(p<0.01\), \sym{***} \(p<0.001\))} \\
	\end{tabular}
