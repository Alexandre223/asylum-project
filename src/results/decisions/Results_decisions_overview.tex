...
\begin{table}[!ht]\centering
	...
	\begin{tabular}{l*{3}{c}}
		\hline\hline
		\input{../../../out/analysis/decisions/tables/acceptance_rate_IM_table1_R15.tex}
		\hline\hline
		\multicolumn{4}{l}{\footnotesize Standard errors in parentheses (\sym{*} \(p<0.05\), \sym{**} \(p<0.01\), \sym{***} \(p<0.001\))}\\
	\end{tabular}
\end{table}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=1\textwidth]{figures_edited/acceptance_rate_IM_graph1_R15.pdf}
...
\begin{table}[!ht]\centering
	...
	\begin{tabular}{l*{2}{c}}
		\hline\hline
		\input{../../../out/analysis/decisions/tables/acceptance_rate_IM_graph1_R15_coef.tex}
		\hline\hline
		\multicolumn{3}{c}{\footnotesize Standard errors in parentheses} \\
		\multicolumn{3}{c}{\footnotesize (\sym{*} \(p<0.05\), \sym{**} \(p<0.01\), \sym{***} \(p<0.001\))}\\
	\end{tabular}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.7\textwidth]{figures_edited/acceptance_rate_IM_graph2_R15.pdf}
	\caption{R15: Acceptance Rate: Predicted Pattern}
\end{figure}
...
\begin{table}[!ht]\centering
	...
	\begin{tabular}{l*{2}{c}}
		\hline\hline
		\input{../../../out/analysis/decisions/tables/acceptance_rate_IM_graph2_R15_coef.tex}
		\hline\hline
		\multicolumn{3}{c}{\footnotesize Standard errors in parentheses} \\
		\multicolumn{3}{c}{\footnotesize (\sym{*} \(p<0.05\), \sym{**} \(p<0.01\), \sym{***} \(p<0.001\))} \\
	\end{tabular}
...
\begin{table}[!ht]\centering
	...
	\begin{tabular}{l*{3}{c}}
		\hline\hline
		\input{../../../out/analysis/decisions/tables/refugeestatus_rate_IM_table1_R15.tex}
		\hline\hline
		\multicolumn{4}{l}{\footnotesize Standard errors in parentheses (\sym{*} \(p<0.05\), \sym{**} \(p<0.01\), \sym{***} \(p<0.001\))}\\
	\end{tabular}
\end{table}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=1\textwidth]{figures_edited/refugeestatus_rate_IM_graph1_R15.pdf}
...
\begin{table}[!ht]\centering
	...
	\begin{tabular}{l*{2}{c}}
		\hline\hline
		\input{../../../out/analysis/decisions/tables/refugeestatus_rate_IM_graph1_R15_coef.tex}
		\hline\hline
		\multicolumn{3}{c}{\footnotesize Standard errors in parentheses} \\
		\multicolumn{3}{c}{\footnotesize (\sym{*} \(p<0.05\), \sym{**} \(p<0.01\), \sym{***} \(p<0.001\))}\\
	\end{tabular}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.7\textwidth]{figures_edited/refugeestatus_rate_IM_graph2_R15.pdf}
	\caption{R15: Refugee Status Rate: Predicted Pattern}
\end{figure}
...
\begin{table}[!ht]\centering
	...
	\begin{tabular}{l*{2}{c}}
		\hline\hline
		\input{../../../out/analysis/decisions/tables/refugeestatus_rate_IM_graph2_R15_coef.tex}
		\hline\hline
		\multicolumn{3}{c}{\footnotesize Standard errors in parentheses} \\
		\multicolumn{3}{c}{\footnotesize (\sym{*} \(p<0.05\), \sym{**} \(p<0.01\), \sym{***} \(p<0.001\))} \\
	\end{tabular}
...
\begin{table}[!ht]\centering
	...
	\begin{tabular}{l*{3}{c}}
		\hline\hline
		\input{../../../out/analysis/decisions/tables/otherpositive_rate_IM_table1_R15.tex}
		\hline\hline
		\multicolumn{4}{l}{\footnotesize Standard errors in parentheses (\sym{*} \(p<0.05\), \sym{**} \(p<0.01\), \sym{***} \(p<0.001\))}\\
	\end{tabular}
\end{table}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=1\textwidth]{figures_edited/otherpositive_rate_IM_graph1_R15.pdf}
...
\begin{table}[!ht]\centering
	...
	\begin{tabular}{l*{2}{c}}
		\hline\hline
		\input{../../../out/analysis/decisions/tables/otherpositive_rate_IM_graph1_R15_coef.tex}
		\hline\hline
		\multicolumn{3}{c}{\footnotesize Standard errors in parentheses} \\
		\multicolumn{3}{c}{\footnotesize (\sym{*} \(p<0.05\), \sym{**} \(p<0.01\), \sym{***} \(p<0.001\))}\\
	\end{tabular}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.7\textwidth]{figures_edited/otherpositive_rate_IM_graph2_R15.pdf}
	\caption{R15: Subsidiary Protection Rate: Predicted Pattern}
\end{figure}
...
\begin{table}[!ht]\centering
	...
	\begin{tabular}{l*{2}{c}}
		\hline\hline
		\input{../../../out/analysis/decisions/tables/otherpositive_rate_IM_graph2_R15_coef.tex}
		\hline\hline
		\multicolumn{3}{c}{\footnotesize Standard errors in parentheses} \\
		\multicolumn{3}{c}{\footnotesize (\sym{*} \(p<0.05\), \sym{**} \(p<0.01\), \sym{***} \(p<0.001\))} \\
	\end{tabular}
