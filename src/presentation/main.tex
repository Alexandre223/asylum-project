...
\scriptsize{\hspace{10ex}Ifo Institute \hspace{29ex} MEA}}}\date{26 July 2017\\[3ex]
{Silvaplana Workshop on Political Economy, Pontresina\\[3ex]
%\newline Location
}}
% End Preamble
%--------------------------------------------------------------------------------------------------%
...
%\begin{itemize}
%\item{Naturalization process is based on federal law and implemented by federal agencies (USCIS). \newline $\rightarrow$ Presidential elections}\\[2ex]
%\item{Immigrants that have been a permanent resident for at least 5 years are entitled to apply and need to pass a number of tests. The application process takes roughly 5 to 8 months. \newline $\rightarrow$ Discretion to accelerate the decision process / to adjust the approval rate}\\[2ex]
%\item{New citizens are already permanent residents. \newline $\rightarrow$ Limited labor market effects}
%\end{itemize}
%	\end{frame}
%--------------------------------------------------------------------------------------------------%
...
%\item Interdependence of asylum policies across countries\\[1ex]
