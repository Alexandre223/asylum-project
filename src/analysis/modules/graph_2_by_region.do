...
foreach var in MENA Africa SEA ECA {
	...
	graph save ./out/analysis/temp/app_graph2_`var'.gph, replace
}
*				


grc1leg ./out/analysis/temp/app_graph2_MENA.gph ///
		./out/analysis/temp/app_graph2_Africa.gph ///
		./out/analysis/temp/app_graph2_ECA.gph ///
		./out/analysis/temp/app_graph2_SEA.gph, ///
		row(2) col(2) legendfrom(./out/analysis/temp/app_graph2_MENA.gph) ///
